...
require (
	...
	github.com/micrease/gorme v1.0.7
	github.com/micrease/meshop-protos v1.3.1
	github.com/micrease/micrease-core v1.3.1
...
require (
	...
	github.com/go-kratos/kratos/contrib/config/consul/v2 v2.0.0-20220414054820-d0b704b8f38d // indirect
